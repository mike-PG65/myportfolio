  ...
  return (
    ...
    >
      ...
      <motion.h2
        ...
        className="text-5xl font-bold text-center mb-20 bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent"
      >
        Education Journey
      </motion.h2>
      ...
      {loading && (
        <div className="flex flex-col justify-center items-center h-60 gap-6">
          <motion.div
            className="w-14 h-14 border-4 border-t-transparent border-purple-500 rounded-full shadow-lg shadow-purple-500/30"
            animate={{ rotate: 360 }}
            transition={{
              repeat: Infinity,
              duration: 1.2,
      ...
      {/* Empty State */}
      {!loading && educationList.length === 0 && !error && (
